...
package.path = package.path .. '/usr/lib/python3.5/site-packages/powerline/bindings/awesome/powerline.lua'
...
beautiful.init("/home/xiaoming/.config/awesome/themes/custom/theme.lua")
...
mytextclock = wibox.widget.textclock(" %Y - %a %b %d | %H:%M ")

-- CPU MONITOR WIDGET
cpubar = wibox.widget.progressbar()
cpubar:set_color(beautiful.fg_normal)
cpubar:set_background_color("#111111")
cpubar:set_width(55)
...
batbar:set_background_color("#111111")
batbar:set_width(55)
...
membar:set_background_color("#111111")
membar:set_width(55)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    tags[s] = awful.tag(taggs, s, awful.layout.layouts[1])
...
-- }}}
awful.util.spawn_with_shell("pgrep compton || ~/bin/myscripts/awesomestartup")
