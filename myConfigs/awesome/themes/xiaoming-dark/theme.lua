...
theme.bg_normal     = "#000000bd" --"#242424" --"#000f02" -- #222222
theme.bg_focus      = "#0000008a" -- "#094766" -- #535d6c
theme.bg_urgent     = "#ff0000"
theme.bg_minimize   = "#0000008a"

theme.fg_normal     = "#00adff"
theme.fg_focus      = "#ffffff"
theme.fg_urgent     = "#ffffff"
theme.fg_minimize   = "#003366"
