...
myWorkspaces = ["main","web","chat","mail","dev","music","java","cal"]

-- Defining my Layout configurations. Quite lot of Layouts.

myLayout = onWorkspace "java" simpleFloat stiled ||| Mirror stiled ||| 
  ...
  where
    ...
    spiraled = spacing 2 $ spiral gRatio
